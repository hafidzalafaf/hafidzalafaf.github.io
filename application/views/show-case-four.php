            ...
            <section id="invoiceku">
                <div class="container container-case">
                    <div class="invoiceku-one">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/float-talk/float-talk1.png') ?>" alt="float-talk-preview">
                        </div>
                    </div>
                    <div class="invoiceku-two">
                        <img src="<?= base_url('assets/images/show-case/float-talk/float-talk2.png') ?>" alt="float-talk-desktop">
                        <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk3.png') ?>" alt="float-talk-mobile">
                    </div>
                    <div class="invoiceku-three bg-blue-light">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/float-talk/float-talk4.png') ?>" alt="float-talk-highlight1">
                            <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk5.png') ?>" alt="float-talk-highlight2">
                            <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk6.png') ?>" alt="float-talk-highlight3">
                        </div>
                    </div>
                    <div class="invoiceku-five">
                        <img src="<?= base_url('assets/images/show-case/float-talk/float-talk7.png') ?>" alt="float-talk-fullpage">
                    </div>
                    <div class="invoiceku-six bg-green-dark">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/float-talk/float-talk8.png') ?>" alt="float-talk-group4">
                            <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk8.png') ?>" alt="float-talk-group5">
                            <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk10.png') ?>" alt="float-talk-group6">
                        </div>
                        <div class="rows end">
                            <img src="<?= base_url('assets/images/show-case/float-talk/float-talk11.png') ?>" alt="float-talk-group4">
                            <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk12.png') ?>" alt="float-talk-group5">
                            <img class="right" src="<?= base_url('assets/images/show-case/float-talk/float-talk13.png') ?>" alt="float-talk-group6">
                        </div>
                    </div>
                </div>
            </section>
