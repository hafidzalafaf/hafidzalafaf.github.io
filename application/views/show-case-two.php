            ...
            <section id="show-case2">
                <div class="container container-case">
                    <div class="show-case2 one">
                        <div class="rows">
                            <img class="left" src="<?= base_url('assets/images/show-case/ngehe/ngehe1.png') ?>" alt="ngehe-preview">
                            <img class="right" src="<?= base_url('assets/images/show-case/ngehe/ngehe2.png') ?>" alt="ngehe-preview2">
                        </div>
                    </div>
                    <div class="show-case2 two">
                        <img class="left" src="<?= base_url('assets/images/show-case/ngehe/ngehe3.png') ?>" alt="ngehe-preview3">
                        <img class="right" src="<?= base_url('assets/images/show-case/ngehe/ngehe4.png') ?>" alt="ngehe-preview4">
                    </div>
                    <div class="show-case2 three bg-dark">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/ngehe/ngehe5.png') ?>" alt="ngehe-preview5">
                        </div>
                    </div>
                    <div class="show-case2 three bg-yellow">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/ngehe/ngehe6.png') ?>" alt="ngehe-preview6">
                            <img src="<?= base_url('assets/images/show-case/ngehe/ngehe7.png') ?>" alt="ngehe-preview7">
                        </div>
                    </div>
                    <div class="show-case2 five bg-dark">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/ngehe/ngehe8.png') ?>" alt="ngehe-preview8">
                            <img src="<?= base_url('assets/images/show-case/ngehe/ngehe9.png') ?>" alt="ngehe-preview9">
                            <img src="<?= base_url('assets/images/show-case/ngehe/ngehe10.png') ?>" alt="ngehe-preview10">
                        </div>
                    </div>
                </div>
            </section>
