            ...
            <section id="invoiceku">
                <div class="container container-case">
                    <div class="invoiceku-one">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku2.png') ?>" alt="invoiceku-preview">
                        </div>
                    </div>
                    <div class="invoiceku-two">
                        <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku3.png') ?>" alt="invoiceku-desktop">
                        <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku4.png') ?>" alt="invoiceku-mobile">
                    </div>
                    <div class="invoiceku-three">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku5.png') ?>" alt="invoiceku-highlight1">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku6.png') ?>" alt="invoiceku-highlight2">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku7.png') ?>" alt="invoiceku-highlight3">
                        </div>
                    </div>
                    <div class="invoiceku-four">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku8.png') ?>" alt="invoiceku-highlight4">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku9.png') ?>" alt="invoiceku-highlight5">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku10.png') ?>" alt="invoiceku-highlight6">
                        </div>
                    </div>
                    <div class="invoiceku-five">
                        <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku11.png') ?>" alt="invoiceku-fullpage">
                    </div>
                    <div class="invoiceku-six">
                        <div class="rows">
                            <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku12.png') ?>" alt="invoiceku-group4">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku13.png') ?>" alt="invoiceku-group5">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku14.png') ?>" alt="invoiceku-group6">
                        </div>
                        <div class="rows end">
                            <img src="<?= base_url('assets/images/show-case/invoiceku/invoiceku15.png') ?>" alt="invoiceku-group4">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku16.png') ?>" alt="invoiceku-group5">
                            <img class="right" src="<?= base_url('assets/images/show-case/invoiceku/invoiceku17.png') ?>" alt="invoiceku-group6">
                        </div>
                    </div>
                </div>
            </section>
